    ...
    return (
        ...
        <>
            <section className='flex justify-center'>
                    <div className="bg-white p-10 rounded-lg md:w-96 my-10 flex-col mx-4">
                        <div className="mb-10">
                        ...
                        <form onSubmit={handleSubmit}
                            ...
                            <div>
                                ...
                                <button onClick={loginfunction}
                                    className="mt-6  text-white w-full py-2 px-6 rounded-lg hover:scale-105 bg-[#8758FF] transition-all mb-6">Ingresar</button>
                        ...
                        <div className=" flex justify-center gap-1">
                            ¿No estas registrado?
                            <Link to="/register" className="text-[#8758FF] font-medium hover:underline transition-all">
                                Registrate
                            </Link>
